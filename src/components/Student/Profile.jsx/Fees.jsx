...
const Fees = ({ subjects }) => {
  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row gap-y-20 gap-x-4 w-full">
      ...
      <div className="bg-card-custom w-full shadow-lg h-full col-span-2 rounded-xl p-5 mt-14">
        <form onSubmit={handleSubmit} onChange={handleChange}>
          <div className="grid grid-cols-12 grid-flow-row auto-rows-min relative gap-y-5">
            ...
            <div className="w-full col-span-12 md:col-auto my-10 md:my-0">
              <Separator
                orientation={`${isMobile ? "horizontal" : "vertical"}`}
                // orientation={"horizontal"}
                className=" md:h-[80%] md:top-10 relative md:left-[57%] before:content-['OR'] before:absolute before:top-[50%] before:left-1/2 md:before:left-0 before:-translate-x-[50%] before:-translate-y-[50%] before:bg-background before:text-3xl"
              />
            </div>
            ...
            <div className="col-span-12 ">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-4 mt-5">
                <p className="text-left md:w-3/5">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos
                  voluptate placeat sunt sequi commodi vitae quam
                </p>
