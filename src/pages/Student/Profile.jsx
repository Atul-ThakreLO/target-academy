...
import EditDpDialog from "@/components/Student/Profile.jsx/edit-dp-dialog";
...
const Profile = () => {
  ...
  function handleProfile() {
    ...
    if (scrollContainerRef.current.scrollTop > 50 && isMobile) {
      setShrink(true);
    } else if (scrollContainerRef.current.scrollTop > 150 && !isMobile) {
      setShrink(true);
    } else {
      setShrink(false);
    }
  ...
  useEffect(() => {
    scrollContainerRef.current.addEventListener("scroll", handleProfile);
  }, []);

  return (
    <div
      ref={scrollContainerRef}
      className="h-[90vh] md:h-[95vh] overflow-y-auto scrollable"
    >
      <div className="trigger">
          ...
          <div className="-mt-10 lg:-mt-32">
            <div
              className={`flex justify-between duration-500 transition-[width] mx-auto ${
                shrink
                  ? "backdrop-blur-sm bg-background w-[90%] md:w-[80%] rounded-full border pl-0 pr-4 shadow-xl"
                  : "w-[100%]"
              } px-4`}
            >
              <div>
                <div className="flex items-center">
                  <div className="relative group">
                    ...
                    <div className="absolute top-0 right-0 bg-background rounded-full hidden group-hover:block">
                      <EditDpDialog defaultData={student} />
                    </div>
                  </div>

                  <span
                    className={`ml-1 md:ml-3 w-max inline-block duration-500 transition-opacity  ${
                ...
                <div
                  className={`ml-2 md:ml-5 duration-500 w-full transition-opacity ${
        ...
        <section className="lg:mt-10">
          <div className="flex flex-col md:flex-row p-3 md:p-4 gap-4 w-full">
            <div className="bg-muted/70 rounded-xl p-3 md:p-6 md:w-1/2">
          ...
          <div className="p-3 md:p-4">
            <div className="bg-muted/70 rounded-xl p-3 md:p-6 md:col-span-2">
...
// p-3 lg:p-4 lg:px-5 grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-flow-row md:auto-rows-min gap-4 w-full
